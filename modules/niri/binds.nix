{ config, ... }:
{
  programs.niri.settings.binds = with config.lib.niri.actions; {
    ...
    "Mod+Ctrl+A".action = center-visible-columns;
    ...
    "Mod+Ctrl+S" = {
      ...
      hotkey-overlay.title = "Screenshot the active screen";
    };
    "Mod+S" = {
      action.screenshot-window = [ ];
      hotkey-overlay.title = "Screenshot the active window";
    };

    "Mod+Shift+T".action =
      spawn "bash" "-c" "slurp | grim -g - - | tesseract stdin stdout -l eng+jpn | wl-copy";
