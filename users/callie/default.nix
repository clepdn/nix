{ config, pkgs, lib, inputs, ... }:
{
  users.users.callie = {
    ...
    openssh.authorizedKeys.keys = [
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIDQpK/dgOaRgax/GP5D/NvuIGWUy7ul6XRw9TQ4+WoT4" # xps
      ...
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIFexR51gVO+v5+mW6roktsex5Im2vxVPlD82Cgd0PxMv" # homura
    ];
    packages = with pkgs; [
      kdePackages.kate
